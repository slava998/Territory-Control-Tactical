...
//put this in oninit
void addShieldVars(CBlob@ this, f32 shieldAngleSize = 30.0f, f32 shieldHealth = 1.0f)
{
	ShieldVars vars;
	vars.direction = Vec2f(0, 0);
	vars.angleTolerance = shieldAngleSize / 2;
	vars.shieldMaxHealth = shieldHealth;
	vars.shieldHealth = shieldHealth;
	vars.enabled = false;
...
bool blockAttack(CBlob@ this, Vec2f direction, f32 damage)
{
	...
	return ((angle_difference) < vars.angleTolerance && vars.shieldHealth > 0);
}
