...
void onInit(CBlob@ this)
{
	...
	//Sound
	settings.FIRE_SOUND = "InfantryCarbine_Fire.ogg"; //Sound when shooting
	settings.RELOAD_SOUND = "InfantryCarbine_Reloading.ogg"; //Sound when reloading

	//Offset
	settings.MUZZLE_OFFSET = Vec2f(-20, -1.8); //Where the muzzle flash appears

	this.set("gun_settings", @settings);

	//Custom
	this.set_string("CustomSoundPickup", "InfantryCarbine_Pickup.ogg");
