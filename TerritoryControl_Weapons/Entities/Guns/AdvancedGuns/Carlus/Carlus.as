...
void onInit(CBlob@ this)
{
	...
	settings.TOTAL = 250; //Max amount of ammo that can be in a clip
	...
	//Sound
	settings.FIRE_SOUND = "Carlus_Shoot.ogg"; //Sound when shooting
	settings.RELOAD_SOUND = "Carlus_Reloading.ogg"; //Sound when reloading
	this.Tag("CustomSoundLoop");

	//Offset
	settings.MUZZLE_OFFSET = Vec2f(-22, -1.5); //Where the muzzle flash appears
	...
	this.set_string("CustomSoundDuringAcceleration", "Carlus_Shoot_Once.ogg");
