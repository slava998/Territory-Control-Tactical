...
void onInit(CBlob@ this)
{
	...
	settings.CURSOR_SIZE = 25; //Size of crosshair that appear when you hold a gun
	...
	//Sound
	settings.FIRE_SOUND = "Rattler_Shoot.ogg"; //Sound when shooting
	settings.RELOAD_SOUND = "Rattler_Reloading.ogg"; //Sound when reloading

	//Offset
	settings.MUZZLE_OFFSET = Vec2f(-18.5, -2.4); //Where the muzzle flash appears

	this.set("gun_settings", @settings);
	
	//Custom
	this.set_string("CustomSoundPickup", "Rattler_Pickup.ogg");
}