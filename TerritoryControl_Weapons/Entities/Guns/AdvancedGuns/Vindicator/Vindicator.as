...
void onInit(CBlob@ this)
{
	...
	//Sound	
	settings.FIRE_SOUND = "Vindicator_Shoot.ogg";//Sound when shooting
	settings.RELOAD_SOUND = "Vindicator_Reloading.ogg"; //Sound when reloading
	...
	this.set_string("CustomCycle", "Vindicator_BoltAction");
	this.set_f32("scope_zoom", 0.28f);
	...
	this.Tag("powerful");
	this.Tag("sniper");
	this.set_string("CustomSoundPickup", "Vindicator_pickup.ogg");
	this.set_f32("CustomBulletLength", 40.0f);
	this.set_f32("CustomShootVolume", 4.0);
}
